...
function ShopProductCard({product}) {
  ...
  return (
    <motion.div variants={anim} initial="initial" animate="animate" exit="exit" layout style={{boxShadow: '4px 10px 15px -3px rgba(0,0,0,0.1)'}} className='relative cursor-pointer group/image w-[150px] m-h-[160px] sm:w-[250px] overflow-hidden sm:m-h-[270px] rounded-sm'>
                <div className='relative h-[100px] sm:h-[200px] w-[100%] overflow-hidden'>
